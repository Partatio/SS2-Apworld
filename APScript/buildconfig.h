...
#define NVSCRIPT_VERSION_MAJOR 0
#define NVSCRIPT_VERSION_MINOR 0
#define NVSCRIPT_VERSION_BUILD 0


#ifdef MODULE_NVSCRIPT
// NVScript version defines
#define SCRIPT_VERSION		NVSCRIPT_VERSION_MAJOR,NVSCRIPT_VERSION_MINOR,NVSCRIPT_VERSION_BUILD,0
#define SCRIPT_VERSTRING	NVSCRIPT_VERSION_MAJOR "." NVSCRIPT_VERSION_MINOR "." NVSCRIPT_VERSION_BUILD
#define SCRIPT_NAME			"NVScript Script Module"
#define SCRIPT_LONGNAME		"NVScript " GAMENAME " DLL"
...
#define SCRIPT_LONGNAME		"NVDebug " GAMENAME " DLL"
#define SCRIPT_COPYRIGHT	"Copyright (C) 2024 Nameless Voice"
#else
#ifdef RC_INVOKED
